...
void SetTemperature_typeEoS(CCTK_ARGUMENTS, EOSType *eos_3p) {

  DECLARE_CCTK_ARGUMENTSX_SetTemperature;
  ...
  if (set_entropy_postinitial) {
    ...
    grid.loop_all_device<1, 1, 1>(
          ...
          [=] CCTK_DEVICE(const Loop::PointDesc &p) CCTK_ATTRIBUTE_ALWAYS_INLINE {
            ...
            temperature(p.I) = eos_3p->temp_from_valid_rho_eps_ye(rho(p.I),eps(p.I),Ye(p.I));
...
extern "C" void SetTemperature(CCTK_ARGUMENTS)
{
  ...
  case eos_3param::IdealGas: {
    ...
    SetTemperature_typeEoS(CCTK_PASS_CTOC, eos_3p_ig);
    break;
  }
  case eos_3param::Hybrid: {
    auto eos_3p_hyb = global_eos_3p_hyb;
    SetTemperature_typeEoS(CCTK_PASS_CTOC, eos_3p_hyb);
    break;
  }
  case eos_3param::Tabulated: {
    auto eos_3p_tab3d = global_eos_3p_tab3d;
    SetTemperature_typeEoS(CCTK_PASS_CTOC, eos_3p_tab3d);
    break;
  }
  default:
    assert(0);

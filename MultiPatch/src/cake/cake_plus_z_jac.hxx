...
#ifndef MULTIPATCH_CAKE_PLUS_Z_JAC_HXX
#define MULTIPATCH_CAKE_PLUS_Z_JAC_HXX
...
inline std::tuple<jac_t, djac_t> cake_plus_z_jac(const PatchTransformations &pt,
  ...
  const auto global_vars =
      pt.local2global(pt, static_cast<int>(patch_piece::plus_z), local_vars);
...
#endif // MULTIPATCH_CAKE_PLUS_Z_JAC_HXX

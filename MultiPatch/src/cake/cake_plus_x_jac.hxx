...
#ifndef MULTIPATCH_CAKE_PLUS_X_JAC_HXX
#define MULTIPATCH_CAKE_PLUS_X_JAC_HXX
...
template <typename T>
inline std::tuple<jac_t, djac_t> cake_plus_x_jac(const PatchTransformations &pt,
  ...
  dJ(2)(0, 0) = 2 * d_core_da + a * d2_core_da_da;
  dJ(2)(0, 1) = d_core_db + a * d2_core_da_db;
  dJ(2)(0, 2) = d_core_dc + a * d2_core_da_dc;
  dJ(2)(1, 0) = d_core_db + a * d2_core_da_db;
  dJ(2)(1, 1) = a * d2_core_db_db;
  dJ(2)(1, 2) = a * d2_core_db_dc;
  dJ(2)(2, 0) = d_core_dc + a * d2_core_da_dc;
  dJ(2)(2, 1) = a * d2_core_db_dc;
  dJ(2)(2, 2) = a * d2_core_dc_dc;
...
#endif // MULTIPATCH_CAKE_PLUS_X_JAC_HXX

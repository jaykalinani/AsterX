...
class eos_1p_polytrope : public eos_1p {
...
CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline CCTK_REAL
eos_1p_polytrope::gm1_from_valid_rho(const CCTK_REAL rho) const {
...
*/
CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline CCTK_REAL
eos_1p_polytrope::gm1_from_valid_p(const CCTK_REAL p) const {
...
*/
CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline CCTK_REAL
eos_1p_polytrope::csnd2_from_valid_gm1(const CCTK_REAL gm1) const {
  return gm1 / (n * (gm1 + 1));
}

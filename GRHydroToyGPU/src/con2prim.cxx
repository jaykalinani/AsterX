...
extern "C" void GRHydroToyGPU_Pressure(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_GRHydroToyGPU_Pressure;
  ...
  const GF3D2<const CCTK_REAL> gf_dens(gf_layout, dens);
  ...
  const GF3D2<const CCTK_REAL> gf_tau(gf_layout, tau);

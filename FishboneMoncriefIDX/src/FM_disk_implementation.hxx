...
CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline CCTK_REAL GRHD_hm1(CCTK_REAL const& xcoord, CCTK_REAL const& ycoord, CCTK_REAL const& zcoord)
{
  ...
  const CCTK_REAL tmp_11 = ((r_at_max_density)*(r_at_max_density)*(r_at_max_density)*(r_at_max_density)) + tmp_3*tmp_7 - 2*tmp_3*tmp_8 - tmp_9*(-tmp_3 + tmp_7);
  const CCTK_REAL tmp_12 = M/((r_at_max_density)*(r_at_max_density)*(r_at_max_density));
  const CCTK_REAL tmp_13 = 4*((tmp_11)*(tmp_11))*tmp_12/((tmp_10)*(tmp_10));
  const CCTK_REAL tmp_14 = sqrt(((r_in)*(r_in)*(r_in)*(r_in))*tmp_13*tmp_5/((tmp_6)*(tmp_6)) + 1);
  const CCTK_REAL tmp_16 = ((xcoord)*(xcoord)) + ((ycoord)*(ycoord)) + ((zcoord)*(zcoord));
  ...
  const CCTK_REAL tmp_23 = -tmp_19*tmp_22*tmp_3 + ((tmp_16 + tmp_3)*(tmp_16 + tmp_3));
  const CCTK_REAL tmp_24 = sqrt(tmp_13*tmp_19*((tmp_21)*(tmp_21))/(tmp_22*((tmp_23)*(tmp_23))) + 1);
  const CCTK_REAL tmp_25 = a*tmp_11*sqrt(tmp_12)/tmp_10;

  const CCTK_REAL hm1 = -1 + sqrt(tmp_23*(tmp_24 + 1)/(tmp_19*tmp_21))*exp((1.0/2.0)*tmp_14 - tmp_17*tmp_25/tmp_23 + tmp_2*tmp_25/tmp_6 - 1.0/2.0*tmp_24)/sqrt(tmp_6*(tmp_14 + 1)/(((r_in)*(r_in))*tmp_5));

  return hm1;
}

CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline void KerrSchild(CCTK_REAL const& xcoord, CCTK_REAL const& ycoord, CCTK_REAL const& zcoord,
                ...
                CCTK_REAL& KDD00, CCTK_REAL& KDD01, CCTK_REAL& KDD02, CCTK_REAL& KDD11, CCTK_REAL& KDD12, CCTK_REAL& KDD22)
{
  ...
  const CCTK_REAL FDPart3_24 = FDPart3_0*((FDPart3_14)*(FDPart3_14))*((FDPart3_22)*(FDPart3_22));
  const CCTK_REAL FDPart3_25 = ((FDPart3_8)*(FDPart3_8));
  const CCTK_REAL FDPart3_26 = FDPart3_0*FDPart3_12*FDPart3_22*FDPart3_9 + FDPart3_0 + FDPart3_5;
  // FDPart3_27 is zero on the z axis
  const CCTK_REAL FDPart3_27 = FDPart3_14*FDPart3_22*FDPart3_26*FDPart3_8 - FDPart3_24*FDPart3_8;
  const CCTK_REAL FDPart3_28 = (1.0/((FDPart3_27)*(FDPart3_27)*(FDPart3_27)));
  const CCTK_REAL FDPart3_29 = FDPart3_14*FDPart3_22*FDPart3_26 - FDPart3_24;
  const CCTK_REAL FDPart3_30 = (1.0/(FDPart3_14*FDPart3_22*FDPart3_25*FDPart3_26*FDPart3_28*FDPart3_29 - FDPart3_24*FDPart3_25*FDPart3_28*FDPart3_29));
  ...
  const CCTK_REAL FDPart3_41 = 2*FDPart3_32*FDPart3_34*FDPart3_36*FDPart3_39;
  ...
  const CCTK_REAL FDPart3_47 = FDPart3_30*(FDPart3_14*FDPart3_22*FDPart3_25*FDPart3_26*FDPart3_31 - FDPart3_24*FDPart3_25*FDPart3_31);
  const CCTK_REAL FDPart3_49 = FDPart3_46*FDPart3_47/((FDPart3_5)*(FDPart3_5)*(FDPart3_5));
  const CCTK_REAL FDPart3_50 = FDPart3_33*FDPart3_6;
  const CCTK_REAL FDPart3_54 = FDPart3_37*zcoord;
  const CCTK_REAL FDPart3_56 = -FDPart3_14*FDPart3_32*FDPart3_36*FDPart3_54*a;
  ...
  const CCTK_REAL FDPart3_60 = FDPart3_46*FDPart3_47*FDPart3_57*FDPart3_59;
  ...
  const CCTK_REAL FDPart3_86 = FDPart3_36*FDPart3_65*FDPart3_83*FDPart3_84;
  ...
  const CCTK_REAL FDPart3_92 = 16*FDPart3_36*FDPart3_58*FDPart3_79*FDPart3_89*FDPart3_91;
  const CCTK_REAL FDPart3_94 = FDPart3_83*FDPart3_84*(FDPart3_12 + FDPart3_73);
  const CCTK_REAL FDPart3_95 = 4*FDPart3_76*FDPart3_94;
  const CCTK_REAL FDPart3_96 = ((a)*(a)*(a)*(a));
  const CCTK_REAL FDPart3_98 = FDPart3_22*FDPart3_43*FDPart3_83*(4*FDPart3_0*FDPart3_10*FDPart3_68*(FDPart3_0 + FDPart3_10*(2*FDPart3_10 + M)) + 4*FDPart3_0*FDPart3_5*(2*FDPart3_10 - M) + 8*pow(FDPart3_5, 5.0/2.0) + FDPart3_96*(FDPart3_10 - M)*cos(4*FDPart3_67) + FDPart3_96*(3*FDPart3_10 + M));
...
CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline void GRHD_velocities(CCTK_REAL const& xcoord, CCTK_REAL const& ycoord, CCTK_REAL const& zcoord,
                     CCTK_REAL &Valencia3velocityU0GF, CCTK_REAL &Valencia3velocityU1GF, CCTK_REAL &Valencia3velocityU2GF)
{
  ...
  const CCTK_REAL FDPart3_0 = ((a)*(a));
  const CCTK_REAL FDPart3_2 = ((xcoord)*(xcoord)) + ((ycoord)*(ycoord)) + ((zcoord)*(zcoord));
  ...
  const CCTK_REAL FDPart3_17 = FDPart3_0*FDPart3_15*FDPart3_16 - ((FDPart3_0 + FDPart3_2)*(FDPart3_0 + FDPart3_2));
  ...
  const CCTK_REAL FDPart3_31 = -FDPart3_27*FDPart3_30*FDPart3_7*a - sqrt(FDPart3_4)*sqrt(FDPart3_16*FDPart3_30)*sqrt(FDPart3_24 + 1.0/2.0);
  const CCTK_REAL FDPart3_32 = (FDPart3_19*FDPart3_25*FDPart3_26*(-4*FDPart3_0*FDPart3_2*FDPart3_28*FDPart3_30*FDPart3_5*((M)*(M)) + FDPart3_23*FDPart3_30*FDPart3_4) - FDPart3_29*FDPart3_31)/(FDPart3_17*FDPart3_28*FDPart3_31*FDPart3_5 - FDPart3_27*FDPart3_29);
...
CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline void GRHD_perturb_pressure(CCTK_REAL &press, CCTK_REAL &eps, CCTK_REAL const &rho) {

  DECLARE_CCTK_PARAMETERS;

  // Generate random number in range [0,1),
  // snippet courtesy http://daviddeley.com/random/crandom.htm
  const CCTK_REAL random_number_between_0_and_1 = ( (CCTK_REAL)rand() / ((CCTK_REAL)(RAND_MAX)+(CCTK_REAL)(1)) );

  const CCTK_REAL random_number_between_min_and_max = random_min + (random_max - random_min)*random_number_between_0_and_1;
...
//CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline void GRMHD_set_A(CCTK_REAL const &press, CCTK_REAL const &xtilde, CCTK_REAL const &ytilde, CCTK_REAL &Ax, CCTK_REAL &Ay, CCTK_REAL &Az) {
//
//  DECLARE_CCTK_PARAMETERS;
//
...
CCTK_DEVICE CCTK_HOST CCTK_ATTRIBUTE_ALWAYS_INLINE inline void GRMHD_set_A(CCTK_REAL const &press, CCTK_REAL const &rho, CCTK_REAL const &xtilde, CCTK_REAL const &ytilde, CCTK_REAL &Ax, CCTK_REAL &Ay, CCTK_REAL &Az) {

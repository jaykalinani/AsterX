...
Loop::GF3D<std::remove_reference<decltype(*HGF)>::type,0,0,0> HGF_(cctkGH,HGF);
Loop::GF3D<std::remove_reference<decltype(*lambdaU0GF)>::type,0,0,0> lambdaU0GF_(cctkGH,lambdaU0GF);
Loop::GF3D<std::remove_reference<decltype(*MU0GF)>::type,0,0,0> MU0GF_(cctkGH,MU0GF);
...
Loop::GF3D<std::remove_reference<decltype(*MU1GF)>::type,0,0,0> MU1GF_(cctkGH,MU1GF);
...
Loop::GF3D<std::remove_reference<decltype(*MU2GF)>::type,0,0,0> MU2GF_(cctkGH,MU2GF);
